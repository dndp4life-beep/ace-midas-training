...
const trainingCourses = [
  { title: "MiDAS Standard", price: "Â£165", note: "Includes Â£40 CTA learner-pass charge", image: images.minibusHero },
  { title: "MiDAS Accessible", price: "Â£210", note: "Includes Â£40 CTA learner-pass charge", image: images.minibusHero },
  { title: "PATS Standard", price: "Â£125", note: "Includes Â£30 CTA learner-pass charge", image: images.interior },
  { title: "PATS Accessible", price: "Â£155â€“Â£185", note: "Attendance or proficiency routes", image: images.interior },
  { title: "First Aid at Work", price: "Â£205â€“Â£225", note: "Blended or 3-day classroom options", image: images.firstAid },
  { title: "Childrenâ€™s Transport First Aid", price: "Â£95â€“Â£135", note: "Optional epilepsy medication module", image: images.firstAid }
];
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        <button type="button" onClick={() => setPage("Home")} className="flex items-center gap-3 text-left">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Training â€¢ Compliance â€¢ Passenger Transport</p>
          </div>
        </button>
...
function HomePage({ setPage }) {
  const cards = [
    ...
    { title: "First Aid & CTFA", text: "First Aid at Work and Childrenâ€™s Transport First Aid with practical scenarios.", image: images.firstAid }
  ];
  return (
      ...
      <section className="relative min-h-[88vh] overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[1.05fr_0.95fr] lg:py-28">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300 md:text-xl">Practical transport-focused training for schools, councils and operators â€” supported by a digital compliance hub for journey reporting, medication logs, attendance, wheelchair checks and incident evidence.</p>
