...
const CONTACT_FORM_FUNCTION_URL = import.meta.env?.VITE_CONTACT_FORM_FUNCTION_URL || (SUPABASE_URL ? `${SUPABASE_URL.replace(/\/$/, "")}/functions/v1/contact-form` : "https://vsenslqoczeutkylnzar.supabase.co/functions/v1/contact-form");
