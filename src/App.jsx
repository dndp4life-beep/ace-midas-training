...
const DEFAULT_MEDIA_SETTINGS = {
  ...
  midas_accessible: { label: "MiDAS Accessible", imageUrl: images.driverSeat, altText: "MiDAS Accessible training", x: 50, y: 50, zoom: 1 },
  pats_standard: { label: "PATS Standard", imageUrl: images.interior, altText: "PATS Standard training", x: 50, y: 50, zoom: 1 },
  ...
  first_aid_at_work: { label: "First Aid at Work", imageUrl: images.firstAid, altText: "First Aid at Work training", x: 50, y: 50, zoom: 1 },
