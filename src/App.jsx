              ...
              <div>
                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-5 grid gap-3">
                    ...
                    }) : <p className="rounded-xl bg-slate-50 p-4 text-sm font-bold text-slate-600">{roryProspectServiceFilter || roryProspectStatusFilter ? "No prospects match the current filters yet." : "No prospects have been added yet."}</p>}
                  </div>
                  {miaEmailPreview ? (
