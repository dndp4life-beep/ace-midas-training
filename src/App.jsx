                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm font-semibold leading-relaxed text-slate-600">Rory organises public UK prospect information, scores opportunity fit and prepares warm outreach briefs for Mia. Rory never sends emails directly.</p>
                    </div>
                  ...
                  <div className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div className="mt-4 grid gap-3 lg:grid-cols-3">
                      ...
                      <select value={prospectForm.recommended_service} onChange={(e) => updateProspectForm("recommended_service", e.target.value)} className="rounded-xl border border-slate-200 p-3 text-sm"><option>First Aid</option><option>PATS</option><option>MiDAS</option><option>Refresher training</option><option>Compliance tracking/support</option></select>
                    ...
                    {safeProspects.length ? safeProspects.map((prospect) => <article key={prospect.id || prospect.organisation_name} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                        <div>
                          ...
                          <p className="mt-2 text-sm font-bold text-emerald-700">Recommended service: {safeText(prospect.recommended_service, "Not scored yet")}</p>
