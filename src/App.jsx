...
export default function App() {
  ...
  function setPage(nextPage) {
    ...
    const path = nextPage === "Subscribe" ? "/subscribe" : nextPage === "MemberWelcome" ? "/member-welcome" : "/";
