            ...
            {activeTab === "AI Operations" ? (
              <div>
                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-slate-700">Today&apos;s summary: Ava found {expiringWithinThirtyDays.length} record(s) expiring within 30 days. Mia sent {remindersSentToday} refresher reminder(s){miaWorkflowStats ? `, with ${miaWorkflowStats.skippedDuplicates || 0} duplicate(s) skipped and ${miaWorkflowStats.failedSends || 0} failed send(s) in the latest run` : ""}. Rory added or updated {prospectsAddedToday} prospect(s). Ellis filtered {emailsFilteredToday} email(s). Nia created {contentDraftsToday} content draft(s). Theo has {bookingApprovalsNeeded} booking approval item(s).</p>
