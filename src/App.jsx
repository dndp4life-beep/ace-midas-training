...
function BackOfficePage({ setPage, posts, setPosts, reviews, setReviews, siteSettings, setSiteSettings, mediaSettings, setMediaSettings, loginNonce }) {
  ...
  const prospectMatchesLibraryFilters = (prospect) => prospectMatchesServiceFilter(prospect) && prospectMatchesOutreachStatusFilter(prospect);
                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-5 grid gap-3">
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                      ...
                      <div className="grid gap-2 lg:grid-cols-[minmax(210px,260px)_minmax(210px,260px)_auto] lg:items-center">
                    ...
                    {roryProspectServiceFilter || roryProspectStatusFilter ? <p className="rounded-xl bg-emerald-50 p-3 text-sm font-bold text-emerald-800">Showing prospects matched to {roryProspectServiceFilter || "all courses/services"} and {roryProspectStatusFilter ? roryProspectStatusFilter.replaceAll("_", " ") : "all outreach statuses"}. Bulk sending will only use qualified high-priority prospects in this filtered view.</p> : null}
                    ...
                    </article>) : <p className="rounded-xl bg-slate-50 p-4 text-sm font-bold text-slate-600">{roryProspectServiceFilter || roryProspectStatusFilter ? "No prospects match the current filters yet." : "No prospects have been added yet."}</p>}
                  </div>
                  {miaEmailPreview ? (
