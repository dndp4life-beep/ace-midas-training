...
function BackOfficePage({ setPage, posts, setPosts, reviews, setReviews, siteSettings, setSiteSettings, mediaSettings, setMediaSettings }) {
  ...
  const highPriorityProspects = safeProspects.filter((prospect) => prospect.priority === "high" && (prospect.review_status || "pending_review") === "pending_review");
        ...
        <div className="mt-6 grid gap-4 lg:mt-8 lg:grid-cols-[240px_1fr] lg:gap-6">
          ...
          <section className="min-w-0 overflow-hidden rounded-2xl bg-white p-4 text-slate-950 shadow-sm sm:p-6">
            ...
            {activeTab === "AI Operations" ? (
              <SafeSectionBoundary title="AI Operations">
              <div>
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  <div>
                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-5 grid gap-3">
                    {safeProspects.length ? safeProspects.map((prospect) => <article key={prospect.id || prospect.organisation_name} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                        <div>
