                ...
                <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-5 grid gap-3">
                    {safeProspects.length ? safeProspects.map((prospect) => <article key={prospect.id || prospect.organisation_name} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                        <div>
                          <h4 className="text-lg font-black">{safeText(prospect.organisation_name, "Unnamed prospect")}</h4>
                          <p className="mt-1 text-sm font-semibold text-slate-700">{safeText(prospect.sector, "Sector not recorded")} | {safeText(prospect.location, "Location not recorded")} | {safeText(prospect.priority, "medium")} priority</p>
