              ...
              <SafeSectionBoundary title="Ellis Operations Centre">
                <div>
                  ...
                  <section className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                    ...
                    <p className="mt-2 text-sm font-semibold leading-relaxed text-slate-600">Phase 1 uses manual intake so you can review Ellis classifications safely before connecting Gmail or Microsoft 365.</p>
                  ...
                  <section className="mt-6 grid gap-6 lg:grid-cols-2">
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                      ...
                      <p className="mt-2 text-sm font-semibold leading-relaxed text-slate-600">Phase 2 will add OAuth-based mailbox connections. Passwords will never be stored.</p>
                      <div className="mt-4 grid gap-3">
                        ...
                        {safeEllisConnections.length ? <p className="text-xs font-bold text-slate-500">{safeEllisConnections.length} mailbox connection metadata record(s) available.</p> : <p className="text-xs font-bold text-slate-500">No live mailbox is connected.</p>}
                      </div>
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
