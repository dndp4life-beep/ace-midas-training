                        ...
                        <article key={draft.id || `${draft.title}-${draft.created_at}`} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                          <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                            <div>
                              ...
                              <p className="mt-2 text-xs font-bold text-slate-500">Created: {formatDisplayDateTime(draft.created_at)} | Status: {safeText(draft.status, "draft")}</p>
                            </div>
