...
const ADMIN_GET_TRAINING_COMPLIANCE_API_URL = "/api/admin-get-training-compliance";
const ADMIN_SAVE_MEMBER_API_URL = "/api/admin-save-member";
const ADMIN_DELETE_MEMBER_API_URL = "/api/admin-delete-member";
const ADMIN_SAVE_TRAINING_RECORD_API_URL = "/api/admin-save-training-record";
const ADMIN_DELETE_TRAINING_RECORD_API_URL = "/api/admin-delete-training-record";
const ADMIN_DELETE_ORGANISATION_API_URL = "/api/admin-delete-organisation";
...
function BackOfficePage({ setPage, posts, setPosts, reviews, setReviews, siteSettings, setSiteSettings, mediaSettings, setMediaSettings }) {
  ...
  async function loadTrainingComplianceData({ quiet = false } = {}) {
    try {
      const response = await fetch(ADMIN_GET_TRAINING_COMPLIANCE_API_URL);
      const text = await response.text();
  ...
  useEffect(() => {
    if (!unlocked || activeTab !== "Training Compliance") return;
  ...
  async function saveTrainingMember(e) {
    ...
    try {
      const response = await fetch(ADMIN_SAVE_MEMBER_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function saveTrainingRecord(e) {
    ...
    try {
      const response = await fetch(ADMIN_SAVE_TRAINING_RECORD_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function deleteTrainingOrganisation(org) {
    ...
    try {
      const response = await fetch(ADMIN_DELETE_ORGANISATION_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function deleteTrainingMember(member) {
    ...
    try {
      const response = await fetch(ADMIN_DELETE_MEMBER_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function deleteTrainingRecord(record) {
    ...
    try {
      const response = await fetch(ADMIN_DELETE_TRAINING_RECORD_API_URL, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
