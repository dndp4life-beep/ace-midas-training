...
function BackOfficePage({ setPage, posts, setPosts, reviews, setReviews, siteSettings, setSiteSettings, mediaSettings, setMediaSettings }) {
  ...
  const latestAvaDailySummary = avaDailySummaryResult?.summary || latestAvaDailyLog?.metadata?.summary || null;
  const latestAvaWeeklySummary = avaWeeklySummaryResult?.summary || latestAvaWeeklyLog?.metadata?.summary || null;
                ...
                <section className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
                  ...
                  <div className="mt-4 grid gap-4 lg:grid-cols-3">
                    ...
                    <div className="rounded-xl bg-white p-4 text-sm font-semibold text-slate-700">
                      ...
                      <p className="mt-2">Records monitored: {latestAvaWeeklySummary?.total_records_monitored ?? trainingRecords.length}. Reminders sent this week: {latestAvaWeeklySummary?.total_reminders_sent_this_week ?? 0}. Failed reminders: {latestAvaWeeklySummary?.failed_reminders ?? 0}.</p>
