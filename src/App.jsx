...
// Set this to false before going live so dynamic Stripe checkout is used.
const USE_STRIPE_TEST_LINK = true;
const STRIPE_TEST_PAYMENT_LINK = "https://buy.stripe.com/4gMfZh9RJegX65Q7ReeEo09";
...
function BookingPage({ course, setPage }) {
  ...
  async function continueToPayment() {
    ...
    setIsLoading(true);
    setPaymentError("");
    if (USE_STRIPE_TEST_LINK) {
      window.location.href = STRIPE_TEST_PAYMENT_LINK;
      return;
    }
    try {
