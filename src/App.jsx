...
// In Stripe Payment Link settings, set After Payment redirect URL to: https://YOUR_DOMAIN/booking-success
const PAYMENT_LINKS = {
  midas: "https://buy.stripe.com/9B614n9RJgp53XIefCeEo08",
  pats: "https://buy.stripe.com/9B614n9RJgp53XIefCeEo08",
  firstaid: "https://buy.stripe.com/9B614n9RJgp53XIefCeEo08"
};
...
const trainingCourses = [
  { title: "MiDAS Standard", price: "£165", note: "Includes £40 CTA learner-pass charge", image: images.minibusHero, paymentKey: "midas" },
  { title: "MiDAS Accessible", price: "£210", note: "Includes £40 CTA learner-pass charge", image: images.minibusHero, paymentKey: "midas" },
  { title: "PATS Standard", price: "£125", note: "Includes £30 CTA learner-pass charge", image: images.interior, paymentKey: "pats" },
  { title: "PATS Accessible", price: "£155–£185", note: "Attendance or proficiency routes", image: images.interior, paymentKey: "pats" },
  { title: "First Aid at Work", price: "£205–£225", note: "Blended or 3-day classroom options", image: images.firstAid, paymentKey: "firstaid" },
  { title: "Children’s Transport First Aid", price: "£95–£135", note: "Optional epilepsy medication module", image: images.firstAid, paymentKey: "firstaid" }
];
...
function BookingPage({ course, setPage }) {
  ...
  const paymentLink = PAYMENT_LINKS[course.paymentKey];
  async function continueToPayment() {
    if (!agree) return;
    if (!paymentLink) {
      setPaymentError("Stripe payment link is not configured for this course.");
      return;
    }
    setIsLoading(true);
    setPaymentError("");
