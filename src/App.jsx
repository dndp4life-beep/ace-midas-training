...
function ContactPage({ siteSettings }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      callAdminAction("save-inbound-message", {
        message: {
          source: "contact_form",
      ...
      }).catch((intakeError) => console.error("Inbound intake mirror error:", intakeError));
...
function BackOfficePage({ setPage, posts, setPosts, reviews, setReviews, siteSettings, setSiteSettings, mediaSettings, setMediaSettings }) {
  ...
  const [aiRules, setAiRules] = useState({
    ...
    theo: { approvalRequired: true, allowedActions: "Gather booking requirements, prepare booking summaries, flag missing details", forbiddenActions: "Confirm training dates, promise availability, change bookings, cancel bookings, agree custom prices, send/request custom Stripe links", escalationTriggers: "Dates, availability, changes, cancellations, custom prices, custom payment links" },
