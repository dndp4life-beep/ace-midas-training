...
${currentEstimate ? `- Indicative estimate: ${currentEstimate.attendee_count} attendee(s), ${currentEstimate.course_title}, listed price ${currentEstimate.listed_price}, approximate subtotal £${currentEstimate.estimated_subtotal}. Say it is indicative and excludes travel/custom requirements.` : ""}
